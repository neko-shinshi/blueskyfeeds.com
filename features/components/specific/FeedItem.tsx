        ...
        <div className="grow">
            <div className="flex place-items-center gap-1">
                ...
                <a href={`https://bsky.app/profile/${item.uri.slice(5).replace("app.bsky.feed.generator", "feed")}`}>
                    <div className="text-blue-500 hover:text-blue-800 underline hover:bg-orange-200 ">{item.displayName}</div>
                </a>
                ...
                <a href={`https://bsky.app/profile/${item.creator.handle}`}>
                    <div className="flex place-items-center group hover:bg-orange-200">
                        ...
                        <span className="text-blue-500 group-hover:text-blue-800 underline">{item.creator.displayName} @{item.creator.handle}</span>
                    </div>
                </a>
            </div>
